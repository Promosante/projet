{{Form::open(array('url'=> URL::route('shadowindicateurs.action',$id)))}}
                          ...
                          <table id="stupidTable" class="table table-hover table-condensed">
                              <thead>
                                  <tr>
                                      ...
                                      <th data-sort="string"><p class="btn btn-default trick" id="tri_descr_indic_shad" onclick="javascript:refresh_result('tri_descr_indic_shad','page_indic_enr_','ligne_indic_enr',{{ceil(count($TousLesIndicateurs)/15)+1}},{{count($TousLesIndicateurs)}},15);" style="width:100%;">Description</p></th>
                                  </tr>
                              </thead>
                              <tbody>
                                <?php define('jj',0); ?>
