{{Form::open(array('url'=> URL::route('shadowOutilsC.action',$id)))}}
<div id="hidden_outils">
    ...
    <div class="panel panel-info" style="margin-top:10px;">
                ...
                <div class="panel-body">
                      ...
                      <div class="table-responsive">  
                          <table id="stupidTable" class="table table-hover table-condensed">
                             ...
                             @for($p=1; $p < ceil(count($TousLesOutils)/15)+1;$p=$p+1)
        ...
        <div class="col-md-6">
            <div class="btn btn-danger" onclick="javascript:hide_hidden_outils();" style="width:100%">Annuler</div>
        </div>
...
<script>
pagine_results('page_outils_','ligne_outils',1,{{ceil(count($TousLesOutils)/15)+1}},{{count($TousLesOutils)}},15);
</script>
{{Form::close()}}